...
public abstract class PersonnageIa {
  ...
  /**
   * Renvoie <b>true</b> si l'emplacement est à deux cases du personnage,
   * <b>false</b> sinon.
   *
   * @param x Coordonnée X de l'emplacement visée
   * @param y Coordonnée Y de l'emplacement visée
   *
   * @return <b>true</b> si l'emplacement visée est à deux cases du {@link PersonnageDonjon}
   */
  public boolean presDe(int x, int y) {
